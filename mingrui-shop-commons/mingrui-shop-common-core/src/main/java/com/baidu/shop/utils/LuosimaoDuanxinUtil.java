...
public class LuosimaoDuanxinUtil {
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-133fff6a116677bcc22596b06050d484";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-133fff6a116677bcc22596b06050d484";//需要使用自己的APIkey
    private static final String SEND_DUANXIN_URL = "http://sms-api.luosimao.com/v1/send.json";//发送短信的接口
    private static final String SEND_SPEAK_URL = "http://voice-api.luosimao.com/v1/verify.json";//发送语音的接口private static final String STATUS_URL = "http://smsapi.luosimao.com/v1/status.json";//查看余额的接口
